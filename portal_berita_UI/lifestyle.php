...
$start = ($page - 1) * $limit;
$sql = "SELECT * FROM news WHERE kategori='lifestyle' ORDER BY str_to_date(`tanggal`, '%d/%m/%Y') DESC LIMIT $start, $limit";
...
$sql = "SELECT count(id) AS id FROM news WHERE kategori='lifestyle'";
$res = mysqli_query($con, $sql);
$newsCount = array();
while ($row = mysqli_fetch_assoc($res)) {
	$newsCount[] = $row;
			...
			<div class="col-md-12">
				<div class="row">
					<div class="col-md-9">
						...
						<div class="row">
							<div class="col-md-12">
								<!-- <?php $tempString = str_replace('"',"", $berita['judul']);?> -->
							...
							<div class="col-md-12">
								<nav aria-label="Page navigation example">
									<ul class="pagination justify-content-center">
										<?php if($start == 0){ ?>
										<li class="page-item">
											<a class="page-link" href="lifestyle.php?page=<?= $Previous; ?>" tabindex="-1" style="display:none;">Previous</a>
										</li>
										<?php }else{ ?>
										<li class="page-item">
											<a class="page-link" href="lifestyle.php?page=<?= $Previous; ?>" tabindex="-1">Previous</a>
										</li>
										<?php } ?>
										<!--<?php if($page==0){ ?>
										<li class="page-item">
										...
										<!-- <?php for($i = 1; $i<= $pages; $i++) :?>
											<li><a class="page-link" href="lifestyle.php?page=<?= $i; ?>" ><?= $i; ?></a></li>
										<?php endfor; ?> -->
										...
										<?php if($page != $pages){ ?>
										<li class="page-item">
									    	<a class="page-link" href="lifestyle.php?page=<?= $Next; ?>">Next</a>
									    </li>
									    <?php } ?>
									</ul>
								</nav>
					...
					<div class="col-md-3">
						...
						<div class="row">
							<div class="col-md-12">
								<form autocomplete="off" action="tampilansearch.php" method="POST" class="d-flex">
									<input class="form-control me-2" name="textBerita" type="search" placeholder="Search Berita" aria-label="Search">
