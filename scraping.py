      ...
      for page in range(1,4):
          ...
          for item in items:
           ...
           for content in contents:
               textHapus = []
               #textHapus = content.findAll('strong')
        ...
        for i in range(1,4):
            ...
            for item in items:
                ...
                for content in contents:
                    ...
                    if(kategori == 'edukasi'):
                        ...
                        for a in listText:
                            ...
                            if str(a.text[1:10].lower())=='baca juga' or str(a.text[0:9].lower())=='baca juga':
                                ...
                                textHapus.append(a.text+' - ')
                    elif(kategori == 'tekno'):   #belum selesai
                        textHapus1 = []
                        listText = content.findAll('strong')
                        listText += content.findAll('a')
                        listText+=content.findAll('time')
                        for a in listText:
                            i+=1
                            if str(a.text[0:12].lower())=='(baca juga :':
                                #print('(Baca juga :'+a.findNext('a').text+' )')
                                tmpText = a.text+a.findNext('a').text+a.findNext('a').findNext('strong').text
                                textHapus1.append(tmpText)
                            elif i == 1:
                                textHapus1.append(a.text+' - ')
                        """listText = content.findAll('strong')
                        for a in listText:
                            if(a.text[:10])=='BACA JUGA:':
                                print(a)
                                print(txtUrl[indekss])"""
                    ...
                    elif(kategori=='lifestyle'):  #belum selesai
                        listText = content.findAll('strong')
                        listText += content.findAll('em')
                        textHapus.append("Baca juga : ")
                        textHapus.append("(Baca juga:")
                        textHapus.append(content.find('br').findNext('strong').text)
                        textHapus.append(content.find('br').findNext('a').text)
                        #textHapus.append(content.find('em').text)
                        ...
                        #print(content.find('br').findNext('a').text)"""
...
#df.to_csv('beritaKompas.csv', index=False, encoding='utf-8')
